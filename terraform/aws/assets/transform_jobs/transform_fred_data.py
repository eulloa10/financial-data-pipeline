...
paths_to_read = generate_date_paths(start_date, end_date, src_bucket, src_prefix)
...
if 'indicator' not in transformed_df.columns:
    ...
    transformed_df = transformed_df.withColumn(
        "indicator",
        F.regexp_extract(F.col("indicator"), r'indicator=([^/]+)', 1)
    )
    logger.info("Indicator column added from file paths.")
...
logger.info("Duplicate records removed based on 'indicator' and 'observation_date'.")
